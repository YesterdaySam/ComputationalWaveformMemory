function [actCell,hactCell,inCell] = ripExtend_fast(pStruct)
%Inputs: 
%pStruct = A struct containing fields set up in the CA3Net_ripExtend_Search.m function or another script
%Outputs: 
