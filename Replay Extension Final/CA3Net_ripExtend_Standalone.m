...
Ww                  = 0.029;        %Weight strength pyr to pyr
...
stimDelay           = 200;          %Wait time to opto pulse from sim start
...
rampPlot = plotRipExtendSingle(aRamp,hRamp,ARamp,tttCell{1},pStruct);
squarePlot = plotRipExtendSingle(aSquare,hSquare,ASquare,tttCell{2},pStruct);
